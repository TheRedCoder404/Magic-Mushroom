...
public class Player : MonoBehaviour
{
    ...
    [SerializeField] private TMP_Text healthText, waveCountText, waveCounterText, shroomsText;
    ...
    public void UpdateShroomCounterText(int shroomCount)
    {
        shroomsText.text = "Shrooms: " + shroomCount;
    }
